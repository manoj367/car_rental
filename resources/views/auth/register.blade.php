...
<html lang="en">
    ...
    <body class="">
                ...
                <div class="row">
                    <div class="col-md-3  col-sm-6  padd-lr0">
                        <div class="wheel-address">
                            ...
                            <ul>
                                <li><span><i class="fa fa-map-marker"></i>Lovely professional University <br>
                                    Jalandhar, Punjab  </span>
                                </li>
                                <li><a href=""><span><i class="fa fa-phone"></i> +91 0123456789</span></a></li>
                                <li><a href=""><span><i class="fa fa-envelope"></i>contact@carrental.com</span></a></li>
                            </ul>
                            <div class="wheel-soc">
        ...
        <div class="wheel-footer-info wheel-bg6">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-sm-6  padd-lr0"><span>&#169; WHEEL 2019 | Designed with Love</span></div>
